    ...
    var AG_defineProperty = (function () {
      ...
      if ("function" == typeof WeakMap) p = WeakMap;
        ...
        t.prototype.set = function (a, b) {
          ...
          d && d[0] === a
            ? (d[1] = b)
            : q(a, this.a, { value: [a, b], writable: !0 });
          return this;
        };
      ...
      function F(a, b, d) {
        ...
        if (!e) {
          ...
          if (!O(a.a.b)) return !1;
          a.g = { value: b, configurable: !0, writable: !0, enumerable: !0 };
          return !0;
        }
        return M(e, b, d);
      }
    ...
    var AG_abortOnPropertyWrite = function (a, b) {
      ...
      window.onerror = function (e) {
        if ("string" === typeof e && -1 !== e.indexOf(c))
          return (
            b && console.warn("AdGuard has caught window.onerror: " + a), !0
          );
    ...
    var AG_abortInlineScript = function (g, b, c) {
      ...
      window.onerror = function (a) {
        if ("string" === typeof a && -1 !== a.indexOf(e))
          return (
            c && console.warn("AdGuard has caught window.onerror: " + b), !0
          );
